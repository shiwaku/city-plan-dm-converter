...
都市計画基本図（DMデータ）をベクトルタイル化し、国土地理院の最適化ベクトルタイル（淡色地図風・標準地図風）およびCS立体図と重ね合わせて表示するWebマップ。表示しているデータは静岡市の1/10,000・1/2,500です。
...
| 機能 | 内容 |
|---|---|
| レイヤー切替 | コンバーターの出力区分（面・線・記号・方向・注記）とCS立体図を個別にON/OFF。全ON/全OFFボタンあり |
